# 国内 AI 厂商与编程产品 — 2026-07-12

> 检索时间：2026-07-12T22:02:49Z UTC｜触发日轮询

## 国内综述（今日最值得开发者关注的 1–3 条）

1. **阿里 Claude 禁令第 3 日**：办公环境 Claude 全系仍禁用（7/10 生效），推荐 Qoder；工信部 NVDB 7/8 风险提示余波持续，国产平替（Qoder、CodeBuddy、OpenCode）讨论升温。
2. **腾讯 CodeBuddy Code v2.103.0 仍为最近更新**：DeepSeek V4 Pro/Flash（1M 上下文）支持持续可用；今日无新版本发布。
3. **DeepSeek V4 预览 + 旧模型名弃用倒计时 12 天**：`deepseek-chat`/`deepseek-reasoner` 将于 **7/24** 停用，开发者须迁移至 V4 API 命名。
...
|-----------|----------------|--------|------|
| 阿里通义/百炼 | 2026-07-12 22:02 | 通义千问、百炼平台 | 模型无新版本；禁令第 3 日持续 |
| 百度文心/Comate | 2026-07-12 22:02 | 文心一言、Comate 官网 | 今日无公开更新 |
| 字节豆包/Trae/火山方舟 | 2026-07-12 22:02 | 豆包、Trae、火山方舟 | 今日无公开更新 |
| 智谱 GLM/CodeGeeX | 2026-07-12 22:02 | 智谱 AI、CodeGeeX | GLM-5.2（6/27）仍最新 |
| 月之暗面 Kimi | 2026-07-12 22:02 | Kimi 官网 | Kimi 产品无新版本 |
| DeepSeek | 2026-07-12 22:02 | DeepSeek 平台 | V4 预览运行中；旧名 7/24 停用倒计时 12 天 |
| 讯飞星火/iFlyCode | 2026-07-12 22:02 | 讯飞开放平台 | 今日无公开更新 |
| 华为盘古/CodeArts | 2026-07-12 22:02 | 华为云、CodeArts | 今日无公开更新 |
| MiniMax | 2026-07-12 22:02 | MiniMax 官网 | 今日无公开更新 |
| 商汤 | 2026-07-12 22:02 | 商汤科技 | 今日无公开更新 |
| 昆仑万维 | 2026-07-12 22:02 | 昆仑万维 | 今日无公开更新 |
| 零一万物 | 2026-07-12 22:02 | 零一万物 | 今日无公开更新 |
| 面壁智能 | 2026-07-12 22:02 | 面壁智能 | 今日无公开更新 |
...
- **7/24 弃用倒计时 12 天**：`deepseek-chat`、`deepseek-reasoner` 将停用
...
⚠️ 以上调用均未在本环境实测（无 `DEEPSEEK_API_KEY`）。
